...
import { RequirementCategoriesManagement } from './RequirementCategories';
...
export function RequirementsManagement() {
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      ...
      {/* Requirement Categories maintenance (formerly its own File
          Maintenance page), in a side drawer over this page. */}
      <AnimatePresence>
        {isCategoriesOpen ? (
          <div className="fixed inset-0 z-50 flex items-stretch justify-end">
            ...
            />
            <motion.div
              className="relative z-10 h-full w-full max-w-5xl border-l shadow-2xl flex flex-col"
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-4">
                <RequirementCategoriesManagement onChanged={() => void refresh({ showLoading: false })} />
              </div>
            </motion.div>
          </div>
        ) : null}
