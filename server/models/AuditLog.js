...
const CATEGORY_RULES = [
  ...
  [
    "maintenance",
    /^(REQUIREMENT_(CREATED|UPDATED|DEACTIVATED|REACTIVATED)$|REQUIREMENT_CATEGORY_|COMPLIANCE_TYPE_|INSPECTION_TYPE_|APPLICATION_TYPE_|DEPARTMENT_|BUILDING_|LAND_USE_|TYPE_OF_CONTRACT_|APPROVAL_LEVEL_)/,
  ],
];
